  ...
  return (
    <main className="lab">
      <aside className="sidebar">
        <Link className="labBrand textBrand" href="/network" aria-label="Nodra dashboard"><span className="brandCopy"><strong>NODRA</strong><small>THE SHIELD FOR<br/>AGENTIC AI</small></span></Link>
