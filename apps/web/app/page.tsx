import { ArrowRight, ChevronDown, ShieldCheck, Search, Database, FileText, Radio, TriangleAlert, ScanSearch, RotateCcw, Building2, Code2, Landmark, HeartPulse } from "lucide-react";
...
<div className="nhActions"><a className="nhGithub" href="https://github.com/Only-time-hash/Nodra" aria-label="GitHub"><GitHubMark/></a><a className="nhSign" href="/auth?intent=signin">Sign in</a><a className="nhPrimary" href="/auth?intent=signup">Get started <ArrowRight/></a></div>
</header>
<div className="nhHeroBody">
<div className="nhHeroCopy"><span className="nhEyebrow">THE AI AGENT SECURITY PLATFORM</span><h1>Secure what your<br/>AI agents can<br/><em>actually do.</em></h1><p>Nodra helps you control, monitor and protect AI agents across your tools, data and infrastructure — so they can be useful, without being risky.</p><div className="nhCtas"><a className="nhPrimary nhLarge" href="/auth?intent=signup">Get started <ArrowRight/></a><a className="nhOutline" href="/docs">Read the docs</a></div><div className="nhSignals"><span><ShieldCheck/><b>Control</b><small>authority and access</small></span><span><Search/><b>Detect</b><small>and stop risky actions</small></span><span><Database/><b>Investigate</b><small>and recover quickly</small></span></div></div>
...
<div className="nhFooterCtaActions"><a className="nhPrimary nhFooterPrimary" href="/auth?intent=signup">Get started <ArrowRight/></a><a className="nhFooterOutline" href="/docs">View docs</a></div>
