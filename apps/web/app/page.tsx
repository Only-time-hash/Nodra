...
<div className="nhBuilder"><span className="nhSectionTag">AI ECOSYSTEM</span><h3>Built for the tools AI teams use.</h3><p>Nodra is being built to protect agent workflows across modern AI and cloud stacks.</p><div className="nhLogoRow" aria-label="AI and cloud ecosystem"><span>OpenAI</span><span>Anthropic</span><span>Google Cloud</span><span>Microsoft</span><span>AWS</span><span>Vercel</span><span>Notion</span></div><small className="nhBrandNote">Company names and marks identify ecosystem platforms only; they do not imply endorsement or partnership.</small></div>
</section>
</main>}