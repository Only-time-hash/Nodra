...
<div className="nhVisual" aria-label="Nodra security control layer"><img src="/nodra-hero-reference.webp" alt="AI Agent passing through Nodra identity, authority, policy and evidence controls to allowed, approval or blocked outcomes"/></div>
</div>
</section></main>}