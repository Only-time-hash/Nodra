...
<div className="nhBuilder"><span className="nhSectionTag">AI ECOSYSTEM</span><h3>Built for the tools AI teams use.</h3><p>Nodra is being built to protect agent workflows across modern AI and cloud stacks.</p><div className="nhLogoRow" aria-label="AI and cloud ecosystem"><span className="brandOpenAI"><i>◎</i>OpenAI</span><span className="brandAnthropic"><i>AI</i>Anthropic</span><span className="brandGoogle"><i>☁</i>Google Cloud</span><span className="brandMicrosoft"><i className="msMark"><b/><b/><b/><b/></i>Microsoft</span><span className="brandAws"><i>aws</i></span><span className="brandVercel"><i>▲</i>Vercel</span><span className="brandNotion"><i className="notionMark">N</i>Notion</span></div><small className="nhBrandNote">Company names and marks identify ecosystem platforms only; they do not imply endorsement or partnership.</small></div>
</section>
</main>}