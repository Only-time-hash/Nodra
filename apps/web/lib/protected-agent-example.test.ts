...
test("rejects unsafe browser capability inputs", () => {
  ...
  for (const url of ["https://localhost/admin","https://api.internal/secrets","https://10.0.0.1/","https://127.0.0.1/","https://169.254.169.254/latest/meta-data/","https://172.16.0.1/","https://192.168.1.1/","https://224.0.0.1/","https://[::1]/","https://[fc00::1]/","https://[fd00::1]/","https://[fe80::1]/","https://[::ffff:127.0.0.1]/"]) {
    assert.throws(()=>parseProtectedModelDecision(JSON.stringify({resourceId:"browser",action:"read",input:{url}})),/invalid sandbox action/, `expected unsafe browser URL to be rejected: ${url}`);
  }
});
