import { intercept, type LabRequest, type RecordedEvent } from "./runtime";
...
export class NodraGateway {
  private rules:PolicyRule[];\n  private tools:Record<string,ToolHandler>;\n  constructor(rules:PolicyRule[], tools:Record<string,ToolHandler>={}) { this.rules=rules; this.tools=tools; }
  register(resourceId:string, handler:ToolHandler){ this.tools[resourceId]=handler; return this; }
